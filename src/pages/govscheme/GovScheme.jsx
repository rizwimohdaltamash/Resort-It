...
<div className='w-full  md:w-2/3 lg:w-1/2 flex flex-col justify-center items-center p-4 lg:p-8 lg:mt-8 mb-8 rounded-lg'>
  <h1 className='text-2xl lg:text-3xl font-bold mb-4 text-center'>
    Stay Updated with <span className='text-[#00a99d]'>GovSchema</span>
  </h1>
  <p className='text-center  lg:text-lg text-gray-700 leading-relaxed'>
    Welcome to <span className='text-[#00a99d] font-semibold'>GovSchema</span>! Stay informed about the latest government schemes and policies. Our platform is dedicated to bringing you the most current and relevant information to help you navigate through the myriad of opportunities provided by the government. Don’t miss out on the benefits that could be yours!
  </p>
  <button
    onClick={() => {
      navigate("/govscheme");
...
<div className=' w-full lg:w-1/2 flex justify-center mt-8 mb-8'>
        ...
        <div className='bg-gray-200 flex justify-center'> <Lottie className='w-2/3' animationData={GovSchemes} /></div>
          ...
          <div className='mt-4 p-1 rounded'>
            ...
            <p className='text-md text-gray-400'>Connecting people with ngo's nation wide, and creating solutions to get all problems solved through GovSchema. </p>
          </div>
        </div>
      </div>
