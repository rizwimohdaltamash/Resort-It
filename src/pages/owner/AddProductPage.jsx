    ...
    <Layout>
      <div className="w-[90%] mx-auto p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="mt-4 lg:w-[20%] bg-[#00a99d] hover:bg-[#105e58] text-white font-bold py-2 px-4 rounded-lg shadow-lg hover:shadow-2xl transition-transform transform hover:-translate-y-1"
          >
            Add Product
          </button>
        </form>
