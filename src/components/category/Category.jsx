...
//             <h1 className="text-center text-[#00a99d] mt-4 lg:mt-0 text-lg lg:text-3xl font-bold mb-4">Browse Various Recyclable Products !</h1>
//             <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 lg:h-full w-[75%] ">
//                 {category.map((item, index) => {
//                     return (
//                         <div 
//                             key={index} 
//                             className="w-full h-[90%] rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105 cursor-pointer  hover:shadow-xl bg-gray-200 hover:bg-[#1f6863] hover:text-white" 
...
const Category = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center mt-0 px-4 h-full lg:pt-4 mb-8 lg:mb-0 bg-gray-50">
            <h1 className="text-center text-[#00a99d] mt-4 lg:mt-0 text-lg lg:text-3xl font-bold mb-4 lg:mb-8">
